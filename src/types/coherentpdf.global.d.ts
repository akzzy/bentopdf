/*
 * coherentpdf.global.d.ts — TypeScript type definitions for Local Edit / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the Local Edit project.
