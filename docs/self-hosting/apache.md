...
Host Local Edit using Apache HTTP Server.
...
```bash
sudo mkdir -p /var/www/localedit
sudo cp -r dist/* /var/www/localedit/
sudo chown -R www-data:www-data /var/www/localedit
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/localedit.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/localedit

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/localedit>
...
Create `/var/www/localedit/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/localedit
sudo chmod -R 755 /var/www/localedit
```
