...
[Hostinger](https://hostinger.com) is a popular shared hosting provider. This guide covers deploying Local Edit to Hostinger's shared hosting.
...
Make sure the `.html` extension rule and language routes are correctly configured. Local Edit uses static HTML files, not SPA routing:
